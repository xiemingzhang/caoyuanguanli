		...
		if (_5c.buttons) {
			...
			for (var i = 0; i < _5c.buttons.length; i++) {
				...
				if (btn == "-") {
					...
					$("<a href=\"javascript:void(0)\"></a>").addClass("l-btn").css("float", "left").text(btn.text || "").attr("icon", btn.iconCls || "").bind("click", eval(btn.handler || function() {})).appendTo(td).linkbutton({
						plain: true
					});
				}
			}
...
(function($) {
	...
	$.fn.datagrid.parseOptions = function(_4ef) {
		var t = $(_4ef);
		return $.extend({}, $.fn.panel.parseOptions(_4ef), {
	...
	$.fn.treegrid = function(_5b6, _5b7) {
		...
		return this.each(function() {
			...
			if (_5b8) {
				...
				$.data(this, "treegrid", {
					options: $.extend({}, $.fn.treegrid.defaults, $.fn.treegrid.parseOptions(this), _5b6),
					data: []
				});
			}
			_527(this);
...
(function($) {
		...
		return this.each(function() {
			...
			if (_5fe) {
				...
				_5fe = $.data(this, "combo", {
					options: $.extend({}, $.fn.combo.defaults, $.fn.combo.parseOptions(this), _5fc),
					combo: r.combo,
					panel: r.panel,
					previousValue: null
				});
	...
	$.fn.combo.parseOptions = function(_603) {
		var t = $(_603);
		return $.extend({}, $.fn.validatebox.parseOptions(_603), {
		...
		return this.each(function() {
			...
			if (_634) {
				...
				_634 = $.data(this, "combobox", {
					options: $.extend({}, $.fn.combobox.defaults, $.fn.combobox.parseOptions(this), _631)
				});
				_62f(this);
				_623(this, _621(this));
			}
	...
	$.fn.combotree = function(_64a, _64b) {
		...
		return this.each(function() {
			...
			if (_64d) {
				...
				$.data(this, "combotree", {
					options: $.extend({}, $.fn.combotree.defaults, $.fn.combotree.parseOptions(this), _64a)
				});
			}
			_63e(this);
		});
...
(function($) {
		...
		return this.each(function() {
			...
			if (_66b) {
				...
				_66b = $.data(this, "combogrid", {
					options: $.extend({}, $.fn.combogrid.defaults, $.fn.combogrid.parseOptions(this), _668)
				});
			}
			_651(this);
		});
	...
	$.fn.combogrid.parseOptions = function(_66e) {
		var t = $(_66e);
		return $.extend({}, $.fn.combo.parseOptions(_66e), $.fn.datagrid.parseOptions(_66e), {
	...
	$.fn.datebox = function(_67f, _680) {
		...
		return this.each(function() {
			...
			if (_682) {
				...
				$.data(this, "datebox", {
					options: $.extend({}, $.fn.datebox.defaults, $.fn.datebox.parseOptions(this), _67f)
				});
			}
			_66f(this);
		});
		...
		return this.each(function() {
			...
			if (_69b) {
				...
				$.data(this, "datetimebox", {
					options: $.extend({}, $.fn.datetimebox.defaults, $.fn.datetimebox.parseOptions(this), _698)
				});
			}
			_685(this);
		});
